...
public class NuxeoSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case NuxeoPackage.NUXEO_CONNECTION_ITEM: {
				NuxeoConnectionItem nuxeoConnectionItem = (NuxeoConnectionItem)theEObject;
				T result = caseNuxeoConnectionItem(nuxeoConnectionItem);
				if (result == null) result = caseConnectionItem(nuxeoConnectionItem);
				if (result == null) result = caseItem(nuxeoConnectionItem);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case NuxeoPackage.NUXEO_CONNECTION: {
				NuxeoConnection nuxeoConnection = (NuxeoConnection)theEObject;
				T result = caseNuxeoConnection(nuxeoConnection);
				if (result == null) result = caseConnection(nuxeoConnection);
				if (result == null) result = caseAbstractMetadataObject(nuxeoConnection);
				if (result == null) result = caseDataProvider(nuxeoConnection);
				if (result == null) result = caseDataManager(nuxeoConnection);
				if (result == null) result = caseElement(nuxeoConnection);
				if (result == null) result = caseDeployedComponent(nuxeoConnection);
				if (result == null) result = casePackage(nuxeoConnection);
				if (result == null) result = caseNamespace(nuxeoConnection);
				if (result == null) result = caseModelElement(nuxeoConnection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseNuxeoConnectionItem(NuxeoConnectionItem object) {
		return null;
	}
