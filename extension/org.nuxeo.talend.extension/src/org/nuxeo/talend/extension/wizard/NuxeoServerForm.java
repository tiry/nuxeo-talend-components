...
public class NuxeoServerForm extends AbstractForm {
    ...
    public NuxeoServerForm(Composite parent, ConnectionItem connectionItem, String[] existingNames, boolean isCreation) {
    ...
    protected void addFields() {
        ...
        nuxeoPassword = new LabelledText(ftpParameterGroup, "Password", 1, SWT.BORDER | SWT.PASSWORD); //$NON-NLS-1$
